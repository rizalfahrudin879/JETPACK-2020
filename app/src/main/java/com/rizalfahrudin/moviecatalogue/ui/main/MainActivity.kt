...
import com.rizalfahrudin.moviecatalogue.ui.main.content.MovieTvFragment.Companion.MAIN
import com.rizalfahrudin.moviecatalogue.ui.main.favorite.FavoriteActivity
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view_pager.adapter = PagerAdapter(this, MAIN)
